...
public static class CardData
{
    internal static readonly List<TripleTriadCardStore> Cards = new List<TripleTriadCardStore>
    {
        ...
        new(369, "Dreamingway", 39368),
        new(370, "Felicitous Furball", 39369),
        new(371, "Anden", 39370),
        new(372, "Suprae-Lugae", 39371),
        new(373, "Gancanagh", 39372),
        new(374, "Menphina", 39373),
        new(375, "Cagnazzo", 39374),
        new(376, "Rubicante", 39375),
        new(377, "Venat", 39376),
        new(378, "Okuri Chochin", 40602),
        new(379, "Gorai the Uncaged", 40603),
        new(380, "Moko the Restless", 40604),
        new(381, "Octomammoth", 40605),
        new(382, "Proto-Carbuncle", 40606),
        new(383, "Goldor", 40607),
        new(384, "Shishio", 40608),
        new(385, "Themis", 40609),
        new(386, "Enenra", 40610),
        new(387, "Golbez", 40611),
        new(388, "Athena", 40612),
        new(389, "Ketuduke", 41381),
        new(390, "Lala", 41382),
        new(391, "Statice", 41383),
        new(392, "PuPu", 41384),
        new(393, "Loquloqui", 41385),
        new(394, "Nophica", 41386),
        new(395, "Althyk", 41387),
        new(396, "Nymeia", 41388),
        new(397, "Halone", 41389),
        new(398, "Thaliak", 41390),
        new(399, "Llymlaen", 41391),
        new(400, "Oschon", 41392),
        new(401, "Durante", 41393),
        new(402, "Eulogia", 41394),
        new(403, "Asura", 41395),
        new(404, "Zeromus", 41396),
        new(405, "Clive Rosfield", 41397),
        new(406, "Pelupelu", 41398),
        new(407, "Alpaca", 41399),
        new(408, "Moblin", 41400),
        new(409, "Branchbearer", 43860),
        new(410, "Rroneek", 43861),
        new(411, "Sentry R8", 43862),
        new(412, "Outrunner", 43863),
        new(413, "Gulool Ja Ja", 43864),
        new(414, "Drowsie", 43865),
        new(415, "Ryoqor Terteh", 43866),
        new(416, "Maulskull", 43867),
        new(417, "Ambrose", 43868),
        new(418, "Valigarmanda", 43869),
        new(419, "Zoraal Ja", 43870),
        new(420, "Queen Eternal", 43871),
        new(421, "Black Cat", 43872),
        new(422, "Otis", 43873),
        new(423, "Cahciua", 43874),
        new(424, "Wuk Lamat", 43875),
        new(425, "Sphene", 43876),
        new(426, "Overseer Kanilokka", 44473),
        new(427, "Ark Angel MR", 44474),
        new(428, "Ark Angel TT", 44475),
        new(429, "Ark Angel GK", 44476),
        new(430, "Ark Angel HM", 44477),
        new(431, "Ark Angel EV", 44478),
        new(432, "Ttokrrone", 44479),
        new(433, "Mica the Magical Mu", 44480),
        new(434, "Prishe of the Distant Chains", 44481),
        new(435, "Shadow Lord", 44482),
    };
}