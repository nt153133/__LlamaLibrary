...
namespace LlamaLibrary.RemoteAgents
{
    public class AgentInclusionShop : AgentInterface<AgentInclusionShop>, IAgent
    {
        internal static class Offsets
        {
            ...
            // pre6.3 [OffsetCN("Search 40 38 B1 ? ? ? ? 0F 86 ? ? ? ? 66 66 0F 1F 84 00 ? ? ? ? Add 3 Read32")]
            internal static int NumberOfSubCategories;

            //0x11A9
            [Offset("Search 41 0F B6 81 ? ? ? ? 48 69 D1 ? ? ? ? 48 69 C8 ? ? ? ? 41 0F B6 81 ? ? ? ? 4E 8B AC 0A ? ? ? ? Add 4 Read32")]
            ...
            //0x1158
            [Offset("Search 42 0F B6 8C 08 ? ? ? ? 41 0F B6 81 ? ? ? ? 48 69 D1 ? ? ? ? 48 69 C8 ? ? ? ? 41 0F B6 81 ? ? ? ? 4E 8B AC 0A ? ? ? ? Add 5 Read32")]
            internal static int CategoryArray;

            //0x1E0
            [Offset("Search 4E 8B AC 0A ? ? ? ? Add 4 Read32")]
            internal static int SubCategoryArrayStart;

            //0x88
            [Offset("Search 48 69 D1 ? ? ? ? 48 69 C8 ? ? ? ? 41 0F B6 81 ? ? ? ? 4E 8B AC 0A ? ? ? ? Add 3 Read8")]
            ...
            //0x19d0
            [Offset("Search 48 69 C8 ? ? ? ? 41 0F B6 81 ? ? ? ? 4E 8B AC 0A ? ? ? ? Add 3 Read32")]
            internal static int StructSizeSubCategory;

            //0x6C
            [Offset("Search 48 6B C8 ? 48 8B 47 ? 4C 03 E9 Add 3 Read8")]
            ...
            //0x19C9
            [Offset("Search F6 84 0A ? ? ? ? ? 75 ? 49 8B 52 ? Add 3 Read32")]
